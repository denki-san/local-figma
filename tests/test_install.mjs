...
test('实际安装包只含运行资源，离线安装后 CLI 与插件可用', { timeout: 60000 }, async t => {
  ...
  for (const file of ['LICENSE', 'README.md', 'README.en.md', 'SECURITY.md', 'CONTRIBUTING.md', 'plugin/main.js', 'plugin/ui.html', 'src/evidence.mjs', 'assets/preview.png', 'assets/usage-flow.png', 'docs/quickstart.md', 'docs/first-task.md', 'docs/agent-quickstart.md']) {
